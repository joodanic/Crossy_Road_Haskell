...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g022.git
$ cd 2022li1g022
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g022.git
$ cd 2022li1g022
```
...
- **A94015** João Carvalho;
- **A100833** Gonçalo Faria Gonçalves;
